                                    ...
                                    <div class="row g-2">
                                        @foreach ($dates as $date)
                                            <div class="col-3 col-md-2">
                                                <a href="{{ route('admin.djs.index') }}?date={{ $date['date']->format('Y-m-d') }}"
                                                    class="text-decoration-none">
                                                    <div class="card card-sm"
                                                        style="aspect-ratio: 1; transition: all 0.2s;">
                                                        <div class="card-body d-flex flex-column align-items-center justify-content-center text-center p-2 position-relative"
                                                            style="height: 100%;">
                                                            <span class="badge bg-blue position-absolute"
                                                                style="top: 4px; left: 4px; font-size: 0.65rem; padding: 2px 6px;">
                                                                {{ $date['dj_count'] }}
                                                            </span>
                                                            <div class="text-uppercase text-muted small fw-bold"
                                                                style="font-size: 0.6rem;">{{ $date['month'] }}</div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-muted mt-1">
                                            <a href="{{ route('admin.djs.index') }}" class="text-decoration-none">View all
                                                →</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="text-muted mt-1">
                                            <a href="{{ route('admin.dates.index') }}" class="text-decoration-none">View
                                                all →</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="icon icon-tabler icon-tabler-clock me-2" width="24"
                                                height="24" viewBox="0 0 24 24" stroke-width="2"
                                                stroke="currentColor" fill="none" stroke-linecap="round"
                                                stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                                ...
                                                                <td>
                                                                    <div class="d-flex align-items-center">
                                                                        <span class="avatar avatar-xs me-2"
                                                                            style="background-image: url(https://ui-avatars.com/api/?name={{ urlencode($dj->name) }}&background=random&size=128)"></span>
                                                                        {{ $dj->name }}
                                                                    </div>
                                                                </td>
                                                                <td>{{ $dj->date ? ($dj->date->date instanceof \Illuminate\Support\Carbon ? $dj->date->date->format('M d, Y') : '-') : '-' }}
                                                                </td>
                                                                <td class="text-muted">
                                                                    {{ $dj->created_at->diffForHumans() }}</td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
